...
public class DBMember : DBBasic
{
  ...
  public void insert() {
       ...
       strSQL = "INSERT INTO member(MemberEmail, MemberDisplayName, MemberGender, MemberDOB, MemberPassword, MemberImage) VALUES ('kai@nus.edu.sg', 'Kai kai', 'Male', '0000-00-00', '222', NULL)";
  ...
  public void insert(String email)
  {
      ...
      strSQL = "INSERT INTO member(MemberEmail, MemberDisplayName, MemberGender, MemberDOB, MemberPassword, MemberImage) VALUES ('" + email + "', 'Kai kai', 'Male', '0000-00-00', '222', NULL)";
  ...
  public void insert(String email, String name)
  {
      ...
      strSQL = "INSERT INTO member(MemberEmail, MemberDisplayName, MemberGender, MemberDOB, MemberPassword, MemberImage) VALUES ('{0}', '{1}', 'Male', '0000-00-00', '222', NULL)";
      strSQL = String.Format(strSQL,email,name);
      MyDatabaseManager().ExecuteNonQuery(strSQL);
